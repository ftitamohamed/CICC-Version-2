...
gradient.addColorStop(0,  '#01780b'); // Starting color
gradient.addColorStop(0.6,  '#003004'); // Starting color
...
function draw() {
  ...
  models.forEach(model => {
    ...
    if (worldPosition.distanceTo(targetPosition) < tolerance) {
      model.scale.set(targetSize + 0.2, targetSize +0.2 , targetSize +0.2 ); // Scale the model at the target position
